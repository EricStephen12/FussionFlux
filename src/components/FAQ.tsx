...
const faqs = [
  ...
  {
    question: "How many credits are used per campaign?",
    answer: "The number of credits used per campaign depends on the number of contacts you send emails to. Each email sent to a contact, whether it's a generated lead or an imported contact, consumes one credit. For example, if you send an email to 100 contacts, it will use 100 credits."
  }
];
